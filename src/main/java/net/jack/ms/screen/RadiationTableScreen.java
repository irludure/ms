...
public class RadiationTableScreen extends AbstractContainerScreen<RadiationTableMenu> {
    private static final ResourceLocation TEXTURE =
            new ResourceLocation(ModifiedSurvival.MOD_ID, "textures/gui/radiation_table_gui.png");

    public RadiationTableScreen(RadiationTableMenu pMenu, Inventory pPlayerInventory, Component pTitle) {
