...
public class FusionRail extends BaseRailBlock {
    public static final EnumProperty<RailShape> SHAPE = BlockStateProperties.RAIL_SHAPE;

    public FusionRail(BlockBehaviour.Properties p_55395_) {
    ...
    protected void updateState(BlockState pState, Level pLevel, BlockPos pPos, Block pBlock) {
        if (pBlock.defaultBlockState().isSignalSource() && (new FusionRailState(pLevel, pPos, pState, pPos)).countPotentialConnections() == 3) {
